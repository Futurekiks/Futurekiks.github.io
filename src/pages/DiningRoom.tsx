  ...
  const products = [
    {
      ...
      originalPrice: "$1,499",
      image: tableImage,
      description: "Elegant dining table for 6-8 people"
    },
    {
      id: 2,
      ...
      originalPrice: "$899",
      image: chairImage,
      description: "Set of 6 comfortable dining chairs"
    },
    {
      id: 3,
      name: "Bar Stools",
    ...
    },
    {
      ...
      originalPrice: "$999",
      image: tableImage,
      description: "Compact round table perfect for small spaces"
    },
    {
      id: 6,
      name: "Bench Seating",
      ...
      <section className="pt-24 pb-16 bg-secondary/50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-5xl md:text-6xl font-light text-primary mb-6">Dining Room Collection</h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Gather around beautiful dining furniture designed to bring family and friends together for memorable meals and conversations.
            </p>
          </div>
        </div>
      </section>
